# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/archivostv/cloudflare.py
import re
import time
import urllib
import urlparse
...
class Cloudflare:
    ...
    def __init__(self, response):
        ...
        try:
            ...
            print 'Metodo #1 (javascript): NO disponible'
            self.js_data = {}
        ...
        if 'refresh' in response['headers']:
            try:
                ...
                print 'Metodo #2 (headers): NO disponible'
                self.header_data = {}
    ...
    def get_url(self):
        if self.js_data.get('wait', 0):
            ...
            response = '%s://%s%s?%s' % (self.protocol,
             self.domain,
